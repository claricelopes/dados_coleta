...
# Lista de professores com nome e user_id do Google Scholar
professores = [
    {"nome": "THAIS GAUDENCIO DO REGO", "user_id": "93u15fEAAAAJ"},
    {"nome": "GLEDSON ELIAS", "user_id": "S1H198kAAAAJ"},
    {"nome": "TEOBALDO LEITE BULHÕES JUNIOR", "user_id": "T9vkFzQAAAAJ"},
    {"nome": "GILBERTO FARIAS DE SOUSA FILHO", "user_id": "N2wRsIoAAAAJ"},
    {"nome": "ALAN KELON OLIVEIRA DE MORAES", "user_id": "330ic4MAAAAJ"}
]

# Criar arquivo CSV com cabeçalho (só uma vez)
with open("artigomais.csv", "w", newline="", encoding="utf-8") as csvfile:
    campos = ["Professor", "Artigo"]
    writer = csv.DictWriter(csvfile, fieldnames=campos)
    writer.writeheader()

# Coletar artigos de cada professor
...
print("\n🎉 Coleta finalizada para todos os professores!")
